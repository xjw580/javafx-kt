        ...
        scene {
            root {
                ...
                vbox {
                    ...
                    // 示例1：单 State 观察
                    addLabel {
                        observe(secondsState) { "⏱ 已运行 $seconds 秒" }
                        fontSize(20.0)
                    }

                    // 示例2：多 State 观察
                    addLabel {
                        observe(secondsState, clickState) { "⏱ $seconds 秒 | 🖱 点击 $clickCount 次" }
                        fontSize(16.0)
                    }
                    ...
                    addLabel {
                        observe(nameState) { "你好，$name！" }
                        fontSize(18.0)
                    }

                    // 示例5：多 State 组合观察
                    addLabel {
                        observe(secondsState, clickState, nameState) {
